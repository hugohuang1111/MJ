...
class TextField extends PIXI.Container {
    ...
    constructor(options = {}) {
        ...
        this.pixiText = new PIXI.Text(options.text | "", options.opstyle || null);
        this.pixiBackground = new PIXI.Graphics();
        this.pixiTextMask = new PIXI.Graphics();
        this.pixiCaret = new PIXI.Graphics();

        this.addChild(this.pixiBackground);
        this.addChild(this.pixiText);
        this.addChild(this.pixiCaret);
        this.addChild(this.pixiTextMask);

        this.localHeight = this.pixiText.style.fontSize + this.pixiText.style.strokeThickness;
    }
